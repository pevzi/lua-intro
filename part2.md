...
Насчёт выделения и освобождения памяти можно не волноваться: всё это происходит автоматически. Если какая-то таблица окажется недоступной через переменные или другие таблицы, то она в конце концов будет удалена из памяти сборщиком мусора.
