...
TODO: написать как-нибудь проще (типа, переменная живёт от момента объявления до конца блока)
...
TODO: вывести после ифа принтом newX и newY чтоб наглядно?
...
TODO: перекрытие происходит не только в случае объявления во вложенном блоке, можно в пределах одного блока объявить несколько переменных с одним именем, и каждая последующая будет перекрывать предыдущие
TODO: так что поиск переменной считай происходит тупо вверх по коду, ближайшая строка с local (или с аргументами, или с переменными цикла) будет тем что нужно
...
TODO: надо ли вообще дополнительную информацию?
