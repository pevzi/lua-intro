...
А, и ещё одна деталь. При tail call существует одна небольшая проблема - отсутствие в стеке информации о вызове функций может затруднить отладку.

- функции высшего порядка
    - map/reduce
    - частичное выполнение функции
- вызов методов через :
